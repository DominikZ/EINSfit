...
from EINSfit import takeClosest #gives you index of value, which is closest to the desired value
import numpy as np
...
for i,sample in enumerate(my_samples):
    t_used,t_idx=takeClosest(sample.used_T,t_wanted)
...
# exampe for dic_data_to_use with no changes
dic_data_to_use_example={'T_start':0, 'T_end': None, 'Q_min':0, 'Q_max': None, 'delete_specific_Q-values_list': None,} 
# example for dic_data_to_use with all temperature values, but without first Q value and maximal Q value at 4.5,
#                                  and Q value 3.1252 is deleted
dic_data_to_use_example2={'Q_min':1, 'Q_max': 4.5, 'delete_specific_Q-values_list': [3.1252,],} 
